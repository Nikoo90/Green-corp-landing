...
class Bubble {
    ...
    init() {
        ...
        this.velocity = generateDecimalBetween(200, 4000)
        this.movementX = generateDecimalBetween(-5, 2) / this.velocity
...
class CanvasBackground {
  ...
  generateBubbles() {
    this.bubblesList = new Array(BUBBLE_DENSITY)
    this.bubblesList.fill(new Bubble(this.canvas),0,BUBBLE_DENSITY)
  }
